...
table.Table.prototype = {
  ...
  setField  : function(name, field) {
    if (typeof field === 'object') {
      this.fields[name] = new Field(name, field.type, field.length, field.indexable, field.description);
    }
  }
}
...
table.Table.prototype = utils.mixin(table.Table.prototype, adapters.getInheritance());
