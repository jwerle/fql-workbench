...
functions.bind('print', function(scope, input) {
  setTimeout(function(){ scope.emit('query.ready', input) }, 0);
});
...
functions.bind('invalid', function(scope, arg){
  setTimeout(function(){ scope.emit('query.ready', "Not a supported command"); }, 0);
});
